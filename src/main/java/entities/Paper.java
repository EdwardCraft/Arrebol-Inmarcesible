...
public class Paper extends GameObject{
	...
	public Paper(float x, float y, ObjectId id, Assets assets,int select){
		super(x, y , id);
		this.game = game;
		this.hud = hud;
		this.select = select;
	...
	public Paper(float x, float y, ObjectId id, RecycleGame game, HubMiniGame hud, int select, Assets assets){
		super(x, y , id);
		this.game = game;
		this.hud = hud;
		this.select = select;
	...
	public void render(Graphics g){
		...
		g.drawImage(assets.plastic, (int)x, (int)y, null);
